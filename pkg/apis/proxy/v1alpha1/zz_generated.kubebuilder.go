...
var SchemeGroupVersion = schema.GroupVersion{Group: "proxy.federation.k8s.io", Version: "v1alpha1"}
...
type NamespacePlacementList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []NamespacePlacement `json:"items"`
}
...
var (
	...
	NamespacePlacementCRD = v1beta1.CustomResourceDefinition{
