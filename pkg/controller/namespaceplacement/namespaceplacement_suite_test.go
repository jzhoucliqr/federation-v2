...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "NamespacePlacement Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("NamespacePlacementController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("NamespacePlacementController")
})
