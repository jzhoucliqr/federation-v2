...
type ProxyV1alpha1Interface interface {
	...
	NamespacePlacementsGetter
}

// ProxyV1alpha1Client is used to interact with features provided by the proxy.federation.k8s.io group.
type ProxyV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ProxyV1alpha1Client) NamespacePlacements(namespace string) NamespacePlacementInterface {
	return newNamespacePlacements(c, namespace)
}
